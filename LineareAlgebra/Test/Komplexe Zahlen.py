...
def multiply_complex_numbers(a_real, a_imag, b_real, b_imag):
    ...
    # Ergebnis darstellen
    explanation.append(f"Das Ergebnis der Matrix ist: {real_part} + {imag_part}i")
...
def divide_complex_numbers(a_real, a_imag, b_real, b_imag):
    ...
    explanation.append(f"Zähler nach Matrix mit dem Konjugierten des Nenners: "
